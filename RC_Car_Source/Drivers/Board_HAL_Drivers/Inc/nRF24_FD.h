...
#ifndef BOARD_HAL_DRIVERS_INC_NRF24_FD_H_
#define BOARD_HAL_DRIVERS_INC_NRF24_FD_H_
...
/**
 * @defgroup Dynamic Pauload lenght mode (nRF24_DPL_xx)
 * @{
 */
...
/**
* API_Brief:  Set transceiver to it's initial state
* Args_Brief: 	none
* Ret_Brief: 	none
...
/**
* API_Brief: Control transceiver power mode
 ...
 */
/**
* API_Brief:	 Get value of the STATUS register
* Args_Brief: 	value of STATUS register
* Ret_Brief:
* @note:
*/
...
#endif /* BOARD_HAL_DRIVERS_INC_NRF24_FD_H_ */
