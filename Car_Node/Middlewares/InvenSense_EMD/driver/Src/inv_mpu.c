...
#if defined AK89xx_SECONDARY || defined HMC5883
...
#ifdef HMC5883
/* This initialization is similar to the one in GY271.c. */

static int setup_compass(void)
{
	GY271_HandleType mag;
	mag.I2Cx = &hi2c1 ;
...
int mpu_get_compass_reg(short *data, unsigned long *timestamp)
{
   ...
   if( GY271_getRawData((int16_t*)data))
	   return -1;
   get_ms(timestamp);
    return 0;
