 ...
 *
 * This file contains the registers addresses definitions and utility defines.
 * This file must be in the include path with other .h files of the I2Cdev library and MPU6050 files
 *
...
#ifndef BOARD_HAL_DRIVERS_INC_MPU6050_DEFS_H_
#define BOARD_HAL_DRIVERS_INC_MPU6050_DEFS_H_



/**
 * @defgroup Registers addresses defines
 * @{
 */
...
/**
 * @defgroup  Bits Positions defines
 * @{
 */
...
/**
 * @defgroup   MPU6050 DMP Memory defines
 * @{
 */
...
/**
 * @defgroup MPU6050 Useful defines
 * @{
 */
...
#define		RAD_TO_DEG			((float)57.295779513f)
...
#endif /* BOARD_HAL_DRIVERS_INC_MPU6050_DEFS_H_ */
